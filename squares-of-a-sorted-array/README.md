...
<p>&nbsp;</p>
<strong>Follow up:</strong><relin-hc> Squaring each element and sorting the new array is very 
          trivial
          , could you find an </relin-hc><code>O(n)</code> solution using a different approach?</div>