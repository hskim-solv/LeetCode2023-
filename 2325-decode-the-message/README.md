<h2><a href="https://leetcode.com/problems/decode-the-message/">2325. Decode the Message</a></h2><h3>Easy</h3><hr><div><p>You are given the strings <code>key</code> and <code>message</code><relin-hc>, which represent a 
          cipher
           key and a secret message, respectively. The steps to decode </relin-hc><code>message</code> are as follows:</p>
...
<ol>
	...
	<li>Each letter in <code>message</code> is then <strong><relin-hc>
          substituted
          </relin-hc></strong> using the table.</li>
